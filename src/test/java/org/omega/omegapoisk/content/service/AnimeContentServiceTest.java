...
class AnimeContentServiceTest {
    ...
    void shouldDeleteAnime() {
        ...
        assertThat(animeContentService.count()).isEqualTo(0);
    }
    ...
    void shouldGetContentCardById() {
        ...
        ContentCard<Anime> card = animeContentService.getCardById(createdAnime.getId());

        assertThat(card).isNotNull();
        assertThat(card.getContent().getSeriesNum()).isEqualTo(createdAnime.getSeriesNum());
    }
    ...
    void shouldGetAnimePage() {
        ...
        assertThat(animeContentService.getContentPage(PageRequest.of(0, pageSize))).hasSize(5);
        assertThat(animeContentService.getContentPage(PageRequest.of(1, pageSize))).hasSize(5);
        assertThat(animeContentService.getContentPage(PageRequest.of(2, pageSize))).hasSize(2);
        assertThat(animeContentService.getContentPage(PageRequest.of(3, pageSize))).hasSize(0);
    ...
    void shouldGetCardsPage() {
        ...
        assertThat(animeContentService.getCardPage(PageRequest.of(0, pageSize))).hasSize(5);
        assertThat(animeContentService.getCardPage(PageRequest.of(1, pageSize))).hasSize(5);
        assertThat(animeContentService.getCardPage(PageRequest.of(2, pageSize))).hasSize(2);
        assertThat(animeContentService.getCardPage(PageRequest.of(3, pageSize))).hasSize(0);
